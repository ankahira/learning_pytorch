...
def load_data():
    ...
    training_data_loader = torch.utils.data.DataLoader(training_data, batch_size=1024, shuffle=True, num_workers=2)

    test_data = datasets.CIFAR10(root='./data', train=False, download=True, transform=transform)
    test_data_loader = torch.utils.data.DataLoader(test_data, batch_size=1024, shuffle=False, num_workers=2)
...
def main():
    ...
    # Spread the model across available GPUs
    ...
    plt.legend()
    plt.savefig('cifar10_data_parallel.png')
    plt.close()
